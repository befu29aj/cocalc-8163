...
the point $P=(1,\sqrt{3})$? (Do not solve the equation $f'(x)=0$ for
this problem unless you want to get some algebra practice. Just
find the function for the optimization and differentiate it.)
