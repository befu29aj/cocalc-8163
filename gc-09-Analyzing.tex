...
\begin{frame}
  \frametitle{Optimization Word Problems}
  {\ubung} A water tank is to be constructed with a square base
  and open top, and is to hold 64 cubic yards. If the cost of the
  sides is \$1 a square yard, and of the bottom \$2 a square yard, what
  are the dimensions when the cost is a minimum? What is the minimum
  cost?
\end{frame}
...
\begin{frame}
  ...
  \end{enumerate}
  \begin{figure}[h]
    \includegraphics[scale=.3]{./diagrams/optleaf.png}
  \end{figure}
\end{frame}
