...
\begin{frame}
  \frametitle{Area Between Curves Exercise}
{\ubung} Find the area of the region enclosed by the parabola
$y=x^{2}$ and the line $y=2^{x}$. You may encounter an equation that
you cannot solve using algebra. Use a numeric method instead.
\begin{figure}[h]
  \includegraphics[scale=0.2]{./diagrams/2hochxminusxzumquadrat.png}
\end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{equation}
    ...
    V=2\pi^{2}Rr^{2}
  \end{equation}
  Note that you could have unrolled the solid torus for a cylinder
  with base $r^{2}\pi$ and height $2R\pi$ as well.
\end{frame}
