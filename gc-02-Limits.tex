...
f(x)=\frac{(x-4)\cdot(\sqrt{x}+2)}{(\sqrt{x}-2)\cdot(\sqrt{x}+2)}\mbox{ on domain }\mathbb{R}\setminus\{4\}
\end{equation}
\begin{equation}
  \label{eq:ahseshij}
  g(x)=\sqrt{x}+2\mbox{ on domain }\mathbb{R}
\end{equation}
...
% many of these exercises are from symbolab.com
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:eneephai}
    \lim_{x\rightarrow{}5}\frac{-2x^{2}+11x-5}{(x-5)(x+3)}
  \end{equation}
\end{frame}
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:eetheijo}
    \lim_{x\rightarrow\infty}\frac{1-5x^{3}}{4x^{2}+x^{6}}
  \end{equation}
\end{frame}
...
\begin{frame}
  \frametitle{Exercises}
    ...
    \begin{equation}
      \label{eq:phemohpo}
      \lim_{x\rightarrow\infty}\frac{7x^{2}-9}{4x+3}
    \end{equation}
\end{frame}
